...
CHECKPOINT_SAVE_DIR=/gs/bs/tgh-24IDU/checkpoints/llava-7b/pretrain
...
export WANDB_NAME="LLaVA-7B-Pre-train-LR_${LR}-WD_${WEIGHT_DECAY}-SEQ_${SEQ_LEN}-EPOCH_${TRAIN_EPOCH}"
