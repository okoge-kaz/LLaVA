...
CHECKPOINT_SAVE_DIR=/gs/bs/tgh-24IDU/checkpoints/llava-13b/finetune
...
export WANDB_NAME="LLaVA-13b-finetune-LR_${LR}-SEQ_${SEQ_LEN}-EPOCH_${TRAIN_EPOCHS}"
...
mpirun -np $NUM_GPUS \
  ...
  python llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /gs/bs/tgh-24IDU/checkpoints/llava-13b/pretrain/mm_projector.bin \
